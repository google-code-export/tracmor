...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of RoleEntityQtypeBuiltInAuthorization objects
			return RoleEntityQtypeBuiltInAuthorization::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::RoleEntityQtypeBuiltInAuthorization()->Param1, $strParam1),
					QQ::GreaterThan(QQN::RoleEntityQtypeBuiltInAuthorization()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single RoleEntityQtypeBuiltInAuthorization object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of RoleEntityQtypeBuiltInAuthorization objects
			return RoleEntityQtypeBuiltInAuthorization::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::RoleEntityQtypeBuiltInAuthorization()->Param1, $strParam1),
					QQ::Equal(QQN::RoleEntityQtypeBuiltInAuthorization()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			$strQuery = sprintf('
				...
				FROM
					`role_entity_qtype_built_in_authorization` AS `role_entity_qtype_built_in_authorization`
				WHERE
					param_1 = %s AND
					param_2 < %s',
				$strParam1, $intParam2);
