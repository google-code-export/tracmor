...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of RoleEntityQtypeCustomFieldAuthorization objects
			return RoleEntityQtypeCustomFieldAuthorization::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::RoleEntityQtypeCustomFieldAuthorization()->Param1, $strParam1),
					QQ::GreaterThan(QQN::RoleEntityQtypeCustomFieldAuthorization()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single RoleEntityQtypeCustomFieldAuthorization object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of RoleEntityQtypeCustomFieldAuthorization objects
			return RoleEntityQtypeCustomFieldAuthorization::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::RoleEntityQtypeCustomFieldAuthorization()->Param1, $strParam1),
					QQ::Equal(QQN::RoleEntityQtypeCustomFieldAuthorization()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			$strQuery = sprintf('
				...
				FROM
					`role_entity_qtype_custom_field_authorization` AS `role_entity_qtype_custom_field_authorization`
				WHERE
					param_1 = %s AND
					param_2 < %s',
				$strParam1, $intParam2);
